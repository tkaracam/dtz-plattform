...
if ($username === 'admin') {
    ...
    echo json_encode(['error' => 'Benutzername ist reserviert.'], JSON_UNESCAPED_UNICODE);
    exit;
}
...
if (find_member_user_by_username($username) || find_student_user_by_username($username)) {
    http_response_code(409);
